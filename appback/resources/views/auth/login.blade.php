...
<head>
    ...
    <head>
        ...
        <link href="{{ asset('public/backend/assets/plugins/jvectormap/jquery-jvectormap-2.0.3.css') }}"
            rel="stylesheet" />
        ...
        <link href="{{ asset('public/backend/assets/plugins/daterangepicker/daterangepicker.css') }}"
            rel="stylesheet" />
...
<body class="bg-light-gray" id="body">
    <div class="container d-flex flex-column justify-content-between vh-100">
        ...
        <div class="copyright pl-0">
            <p class="text-center">
                <a class="text-primary" href="http://localhost:3000/" target="_blank">Amadou - 2024</a>.
            </p>
        </div>
    </div>
</body>
